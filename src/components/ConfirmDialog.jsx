        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
            <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-md animate-fade-in">
                <div className="flex flex-col items-center text-center space-y-4 ">
                    <div className="flex bg-green-100 p-3 rounded-full">
                ...
                <div className="mt-10 flex justify-center gap-3">
                    ...
                    <button
                        onClick={onOk}
                        className="px-6 py-2 rounded-xl bg-gradient-to-r from-green-500 to-green-500 text-white font-semibold shadow hover:shadow-lg transition">
                        OK
                    </button>
                </div>
            </div>
