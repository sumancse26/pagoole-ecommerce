                ...
                <form className="space-y-6" onSubmit={submitForm}>
                    ...
                    <div className="flex justify-center gap-3 pt-4 border-t border-gray-300 dark:border-neutral-600">
                        ...
                        <button
                            ...
                            type="submit"
                            className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold text-white bg-gradient-to-r from-green-600 to-green-600 hover:from-green-700 hover:to-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition">
